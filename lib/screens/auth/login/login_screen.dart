...
import 'package:comiverse_app/core/helper/validator_helper.dart';
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppPallete.primaryLight.withValues(alpha: 0.4),
                    blurRadius: 16,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ___buildTextField(
                  id: LoginScreenRebuildId.emailField,
                ...
                const SizedBox(height: 8),
                ___buildTextField(
                  id: LoginScreenRebuildId.passwordField,
                  hint: "*****",
                  icon: Icons.lock,
                  isPassword: true,
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              ...
                              controller.onTapToRegisterScreen();
                            },
                          style: TextStyle(
                            color: AppPallete.primaryMain,
                            fontWeight: FontWeight.bold,
